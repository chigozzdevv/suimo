  ...
  return (
    <section>
      ...
      <div className="mt-12 grid gap-8 lg:grid-cols-2">
        ...
        >
          <ProblemPanel title="AI Agents struggle with" problems={agentProblems} />
        </motion.div>
        <motion.div
          initial={{ opacity: 0, x: 20 }}
          whileInView={{ opacity: 1, x: 0 }}
          ...
          transition={{ duration: 0.6, delay: 0.2 }}
        >
          <ProblemPanel title="Content Owners lose from" problems={ownerProblems} />
        </motion.div>
      </div>
    </section>
  )
    ...
    <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-transparent p-6 md:p-8">
      ...
      <div className="divide-y divide-white/5">
        {problems.map((problem) => {
          ...
          return (
            <div key={problem.title} className="flex items-start gap-4 py-5 first:pt-0 last:pb-0">
