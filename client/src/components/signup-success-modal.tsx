        ...
        >
          ...
          >
            <div className="text-center">
              ...
              <h2 className="mb-2 text-2xl font-medium text-parchment">
                Welcome to Suimo!
              </h2>
              ...
              <div className="mb-4 rounded-2xl border border-white/10 bg-white/5 p-4 text-left">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1 break-all font-mono text-xs text-sand hover:text-parchment"
                >
              ...
              <Button
                ...
                className="w-full bg-[#cfbea0] text-black hover:bg-[#cfbea0]"
              >
