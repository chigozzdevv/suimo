...
(function main() {
  ...
  envText = setEnvKV(envText, 'ED25519_PRIVATE_KEY_PATH', './keys/oauth_private_key.pem');
  ...
  envText = setEnvKV(envText, 'SUI_USDC_TYPE', '0xa1ec7fc00a6f40db9693ad1415d0c193ad3906494428cf252621037bd7117e29::usdc::USDC');
