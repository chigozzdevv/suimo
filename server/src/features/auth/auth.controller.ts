...
export async function signupController(
  ...
  reply.header(
    "Set-Cookie",
    buildSessionCookie(res.auth.token, req.headers.host),
  );
...
export async function walletChallengeController(
  req: FastifyRequest,
  reply: FastifyReply,
) {
...
export async function walletLinkController(
  req: FastifyRequest,
  reply: FastifyReply,
) {
...
export async function walletLoginController(
  req: FastifyRequest,
  reply: FastifyReply,
) {
  const body = walletVerifyInput.parse(req.body);
...
export async function sessionExchangeController(
  req: FastifyRequest,
  reply: FastifyReply,
) {
