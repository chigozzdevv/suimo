...
import {
  ...
  listCatalogResourcesController,
  getCatalogResourceController,
} from "@/features/resources/resources.controller.js";
import {
  createResourceInput,
  updateResourceInput,
...
export async function registerResourcesRoutes(app: FastifyInstance) {
  ...
  r.post(
    "/resources",
    { preHandler: [requireUser], schema: { body: createResourceInput } },
    createResourceController,
  );
  r.put(
    "/resources/:id",
    { preHandler: [requireUser], schema: { body: updateResourceInput } },
    updateResourceController,
  );
  r.delete(
    "/resources/:id",
